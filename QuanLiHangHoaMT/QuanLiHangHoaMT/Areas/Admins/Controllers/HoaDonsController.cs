...
namespace QuanLiHangHoaMT.Areas.Admins.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHoaDon,TenHoaDon,ThanhTien,SoLuong,DonGia,MaNhanVien,MaKhachHang,MaHangHoa")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHoaDon,TenHoaDon,ThanhTien,SoLuong,DonGia,MaNhanVien,MaKhachHang,MaHangHoa")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {

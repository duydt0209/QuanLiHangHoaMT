...
namespace QuanLiHangHoaMT.Areas.Admins.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNhanVien,TenNhanVien,NgaySinhNV,DiaChiNV,QueQuanNV,SoDT")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNhanVien,TenNhanVien,NgaySinhNV,DiaChiNV,QueQuanNV,SoDT")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
